...
public class SkullEnemy extends Enemy
{
    ...
    public SkullEnemy(Player player, Vector2 start_xy, TiledMapTileLayer environment,int score, int patrol_range, boolean isFinalBoss)
    {
        ...
        // collider
        collider = new Rectangle(super.getPosition().x - 200f, super.getPosition().y - 200f, skullWidth * this.scale, skullHeight * this.scale);
    }
    ...
    public void update(float delta)
    {
        ...
        this.collider.setPosition(new Vector2(super.getPosition().x - 200, super.getPosition().y -200));
    }
